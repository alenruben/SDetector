        ...
        <div class="konten khusus2">
            <div class="konten_dalem khusus3">
                    ...
                    <?php
                        if ($hasil && mysqli_num_rows($hasil) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($hasil)) {
                                ...
                                // Kondisi column logic based on 'asap' value
                                if ($row['asap'] >= 0 && $row['asap'] <= 250) {
                                    $kondisi = "Blower dan Buzzer OFF";
                                } elseif ($row['asap'] >= 251 && $row['asap'] <= 300) {
               ...
               <div style="display: flex; gap: 10px; margin-top: 20px;">
                <form action="ex_pdf.php" method="POST">
                    <input type="hidden" name="start_date" value="<?php echo $start_date; ?>">
                    <input type="hidden" name="end_date" value="<?php echo $end_date; ?>">
                    <button type="submit" class="btn btn-red-pdf">Generate PDF</button>
                </form>

                <form action="excel.php" method="POST">
                    <input type="hidden" name="start_date" value="<?php echo $start_date; ?>">
                    <input type="hidden" name="end_date" value="<?php echo $end_date; ?>">
                    <button type="submit" class="btn btn-green-excel">Generate EXCEL</button>
                </form>
